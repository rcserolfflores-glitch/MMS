<?php
// create_midwife_table.php
// Run this from CLI or visit in browser (only on dev/local) to create the midwife_info table
// Usage (CLI): php create_midwife_table.php
...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS midwife_info (
        ...
        UNIQUE KEY ux_midwife_user (user_id)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;";

    $pdo->exec($sql);
    echo "OK: midwife_info table created or already exists.\n";

    // ensure uploads dir exists (shared with doctors/avatars)
    ...
    // show table definition (shortened)
    $stmt = $pdo->query("SHOW CREATE TABLE midwife_info");
