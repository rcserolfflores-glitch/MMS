...
// allow admin, midwife or doctor users to verify payments
if (!isset($_SESSION['user_id']) || !in_array(($_SESSION['user_type'] ?? ''), ['admin','midwife','doctor'])) {
...
try {
    ...
    // ensure payments table exists (non-destructive)
    ...
    // add verification/paid columns if missing
    $cols = [
